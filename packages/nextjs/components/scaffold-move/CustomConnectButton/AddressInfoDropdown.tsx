...
export const AddressInfoDropdown = ({ address, blockExplorerAddressLink, setShow }: AddressInfoDropdownProps) => {
  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary tabIndex={0} className="btn btn-secondary btn-sm bg-primary border border-primary p-1 shadow-md dropdown-toggle gap-0 !h-auto">
        ...
        >
          ...
          <li onClick={() => setShow(true)} className={selectingNetwork ? "hidden" : ""}>
            <div className="btn-sm !rounded-xl flex gap-3 py-3">
